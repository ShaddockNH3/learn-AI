...
本轮学习内容不会有太高的要求（毕竟我们不是专门搞爬虫的）。你只需要掌握最基础的能力：使用 requests 发起请求、使用 XPath 等工具进行数据提取、使用更强大的浏览器模拟工具 Selenium（它能有效应对许多反爬机制），以及阅读文档并通过 API 获取数据。
...
> 使用校园网爬取不会遭到任何反爬机制。
>
> 实际项目中，像作业 1 这样完全没有反爬机制的情况非常少见，你更多会遇到作业 2 - 4 及 bonus 中描述的场景。
>
