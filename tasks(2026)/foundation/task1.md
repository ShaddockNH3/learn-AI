...
关于本次作业，你需要完成所有文档，完成作业 1，并从作业 2 - 4 中选择至少**两**个来完成。

需要注意，对于作业 1 - 3，你可以采用 clone 本仓库的做法来获取代码框架，无需 fork 一份；对于作业 2 - 4，**你必须使用 typehint（如果给的框架没有，你需要自行添加），并通过 pylance（或其他等同效力插件）的检查**。
...
这份文档需要在你完成作业 1，2、3、4 后完成。

写一篇文档阐述一下你在作业中碰到的和终端相关的问题，并且解释 VS Code / Pycharm 右上角的三角形运行按钮（如果有的话）是什么意思。
...
那么你可以阅读 [Campus_IF_Love/README.md](Campus_IF_Love/README.md) 来窥视他梦境的一角 ...
...
> [!NOTE]
> 这是一个长期任务，不要求在本轮内完成，但也应该在 Foundation 结束之前完成。
...
3. [missing semester](https://missing.csail.mit.edu/)（推荐）
4. [missing semester b 站搬运视频](https://www.bilibili.com/video/BV1CkArz1E4o/?spm_id_from=333.337.search-card.all.click)（推荐）
5. [missing semester 油管](https://www.youtube.com/playlist?list=PLyzOVJj3bHQunmnnTXrNbZnBaCA-ieK4L)
6. [Shell 基础及 CLI 工具推荐 | 实用技能拾遗第一讲 | 浙江大学计算机学院朋辈辅学【直播回放】_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1T84y1w7wB)

除此之外，对于大一的同学，一些计算机的基本常识请学习一下上述的两个课程中的一个
